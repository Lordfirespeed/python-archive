...
with open("Input/2019day9input.txt") as inputfile:
    startregister = [int(n) for n in inputfile.readline().strip().split(",")]

part1 = IntcodeComputer("comp", startregister, 1)
print(part1.execute()[0][0])
part2 = IntcodeComputer("comp", startregister, 2)
print(part2.execute()[0][0])
